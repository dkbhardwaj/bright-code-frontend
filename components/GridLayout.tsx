...
import { GridLayoutBlade } from "./PageBuilder/section.types";

export interface GridLayoutProps {
    data: GridLayoutBlade;
}
...
const GridLayout: React.FC<GridLayoutProps> = ({ data }) => {
    // For now, this is static using the structure from the old GridCards.
    // Replace with real props usage later.
    const { theme, sectionPadding, sectionId, link, rows } = data;
    ...
    return (
        <section id={sectionId} className={`grid-layout-section ${safePadding} ${theme === "dark" ? "darkMode" : ""}`}>
