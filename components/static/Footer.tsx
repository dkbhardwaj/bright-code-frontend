...
const StaticFooter: React.FC<FooterProps> = ({ theme = "light", hideLinks }) => {
      ...
      <div className="container">
        <div className="inner-wrap">
          ...
          <div className="footer-top">
            <div
              className={`footer-top-left mr-[20px] flex ${hideLinks ? "flex-col" : "flex-wrap items-center"
                }`}
            >
              <Link href="/" className={`footer-logo-link mb-[10px] ${hideLinks ? "" : "mr-[20px]"}`}>
                <Image
            ...
            <div className="footer-top-right">
              {hideLinks ? contactSocialBlock : <span className="">{TAGLINE}</span>}
            </div>
          </div>
