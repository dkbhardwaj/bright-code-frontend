...
const comparisonData = {
    ...
    comparisonRows: [
        {
            leftText: "You're building something real and need a partner who moves fast without cutting corners.",
            rightText: "You need a vendor to execute a fully-formed brief, not a thinking partner.",
        },
        {
            leftText: "You value directness over decks, and want thinking that challenges yours.",
            rightText: "Budget is the primary filter and you're comparison shopping on hourly rate.",
        },
        {
            leftText: "Your timeline is tight and your standards aren't and looking for High Quality Product.",
            rightText: "You're not ready to move for 6+ months during the software development",
        },
        {
            leftText: "You're ready to make decisions and own the outcome solely within the product.",
            rightText: "No hard feelings either way. The filter exists so that the engagements that do happen can go deep",
        },
    ],
